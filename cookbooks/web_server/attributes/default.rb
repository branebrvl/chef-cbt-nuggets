default['php']['packages'] = %w{ php php-common php-cli php-mbstring php-gd php-pdo php-mysqli php-mysql php-pgsql php-sqlite php-pecl-memcached php-mcrypt php-fpm php-imagick php-intl php-xdebug}
